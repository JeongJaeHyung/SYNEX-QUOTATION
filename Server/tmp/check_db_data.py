...
def check_data_via_api():
    ...
    for mr in labor_resources:
        ...
        print("-" * 60)
        print(f"📌 Resource Link (MachineResources Snapshot)")
        ...
        if part:
            ...
            print(f"      - Found: ❌ NO (Orphaned Data or Missing Link)")
            print(f"      - Warning: 해당 리소스 ID({resource_id})의 마스터 정보가 API 응답에 누락되었습니다.")
