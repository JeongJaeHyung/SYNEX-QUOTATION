...
#
# 견적서(Machine)와 자재(Resources) 간의 관계를 정의하고,
# 견적서에 포함된 각 자재의 상세 정보(수량, 적용 단가 등)를 기록하는 SQLAlchemy 모델입니다.
# - 견적서의 BOM(Bill of Materials) 역할을 합니다.
#

from sqlalchemy import Column, String, Integer, ForeignKeyConstraint # 컬럼 타입 임포트
