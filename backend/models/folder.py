...
class Folder(Base):
    ...
    headers = relationship(
        "Header", back_populates="folder", cascade="all, delete-orphan"
    )
    detaileds = relationship(
        "Detailed", back_populates="folder", cascade="all, delete-orphan"
    )
    price_compares = relationship(
        "PriceCompare", back_populates="folder", cascade="all, delete-orphan"
    )
