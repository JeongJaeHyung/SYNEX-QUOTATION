...
Revision ID: 7cbe471804a9
Revises: 
Create Date: 2025-12-19 14:21:30.502014
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['machine_id'], ['machine.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['price_compare_id'], ['price_compare.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('price_compare_id', 'machine_id', 'major', 'minor')
    )
