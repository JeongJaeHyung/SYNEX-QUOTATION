...
async def machine_list(request: Request):
    ...
    return templates.TemplateResponse(
        "template/quotation/machine/machine_list_direct.html",
        {"request": request, "current_page": "quotation_machine"},
    )
...
async def machine_form(request: Request):
    ...
    """
    return templates.TemplateResponse(
        "template/quotation/machine/machine_create.html",
        {"request": request, "current_page": "quotation_machine"},
    )
...
async def redirect_create(request: Request):
    ...
    return RedirectResponse(
        url="/service/quotation/machine/form?mode=create", status_code=302
    )
