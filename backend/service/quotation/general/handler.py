...
async def default_list(request: Request):
    ...
    return templates.TemplateResponse(
        "template/quotation/general/default_list.html",
        {"request": request, "current_page": "quotation_default"},
    )
...
async def default_form(request: Request):
    """생성/조회/수정 통합 페이지"""
    return templates.TemplateResponse(
        "template/quotation/general/default_create.html",
        {"request": request, "current_page": "quotation_default"},
    )
...
async def price_compare_register_sub(
    request: Request, folder_id: str = Query(..., description="연동할 Folder ID")
):
    """
    내정가 견적비교서 생성 페이지 (Sub View)
    - 폴더 시스템에서 호출되며, folder_id를 필수로 받습니다.
    """
    return templates.TemplateResponse(
        "template/quotation/general/price_compare_register_sub.html",
        {
            "request": request,
...
async def price_compare_detail_view(request: Request, price_compare_id: str):
    ...
    """
    return templates.TemplateResponse(
        "template/quotation/general/price_compare_detail.html",
        {
            "request": request,
            "current_page": "quotation_default",
            "id": price_compare_id,
...
async def detailed_register_view(
    ...
    - URL: /service/quotation/general/detailed/register?folder_id=UUID
    """
    return templates.TemplateResponse(
        "template/quotation/general/detailed_register.html",
        {
            "request": request,
            "current_page": "quotation_default",
            "folder_id": folder_id,
...
async def detailed_view(request: Request, detailed_id: str):
    ...
    return templates.TemplateResponse(
        ...
        {"request": request, "current_page": "quotation_default", "id": detailed_id},
    )
...
async def header_view(request: Request, header_id: str):
    ...
    return templates.TemplateResponse(
        ...
        {"request": request, "current_page": "quotation_default", "id": header_id},
    )
...
async def header_register_view(
    ...
    """
    [명칭 수정] 견적서(갑지) 생성 페이지
    - URL: /service/quotation/general/header/register?folder_id=UUID
    """
    return templates.TemplateResponse(
        "template/quotation/general/header_register.html",
        {
            "request": request,
            "current_page": "quotation_default",
            "folder_id": folder_id,
...
async def redirect_create(request: Request):
    ...
    return RedirectResponse(
        url="/service/quotation/default/form?mode=create", status_code=302
    )
...
def price_compare_form(request: Request):
    return templates.TemplateResponse(
        "quotation/general/price_compare_detail.html", {"request": request}
    )
