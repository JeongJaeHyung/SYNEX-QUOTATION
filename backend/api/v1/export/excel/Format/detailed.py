...
def create_excel(data: Dict[str, Any]) -> BytesIO:
    ...
    fill_category = PatternFill(start_color="F3F4F6", end_color="F3F4F6", fill_type="solid")  # 연회색
    ...
    fill_note_head = PatternFill(start_color="F8FAF6", end_color="F8FAF6", fill_type="solid")  # 연두색
    ...
    # Row 2: 테이블 헤더
    # ========================================================================
    headers = ['No', '장비명', '품명', '규격', '수량', '단위', '단가', '공급가액', '비고']
